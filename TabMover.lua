...
RR.ForceSafePointOnLimbs                  = ui_reference("RAGE", "Aimbot", "Force safe point on limbs")           RR.MaximumFov                             = ui_reference("RAGE", "Aimbot", "Maximum FOV")
RR.QuickStop                              = ui_reference("RAGE", "Other", "Quick stop")                           RR.DelayShot                              = ui_reference("RAGE", "Other", "Delay shot")
...
RM.EasyStrafe                             = ui_reference("MISC", "Movement", "Easy strafe")                       RM.HideFromObs                            = ui_reference("MISC", "Settings", "Hide from OBS")
...
RM.LogDamageDealt                         = ui_reference("MISC", "Miscellaneous", "Log damage dealt")
--------------------------------------------------------------------------------------------------------------SKINS-REF----------------------------------------------------------------------------------------------------
