...
RR.MaximumFov                             = ui_reference("RAGE", "Aimbot", "Maximum FOV")                         RR.RemoveSpread                           = ui_reference("RAGE", "Other", "Remove spread")
...
RR.OverrideAwp                            = ui_reference("RAGE", "Aimbot", "Override AWP")                        
--------------------------------------------------------------------------------------------------------------ANTI-AIM-REF-------------------------------------------------------------------------------------------------
