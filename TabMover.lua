...
local function CopyRage()
    ...
    Z.SR_AutomaticScope                     = ui.get(Z.R_AutomaticScope)                                      Z.SR_ReduceAimStep                     = ui.get(Z.R_ReduceAimStep)
end
...
local function PasteRage()
    ...
    ui.set(Z.R_AutomaticScope, Z.SR_AutomaticScope)                                                           ui.set(Z.R_MaximumFov, Z.SR_MaximumFov)                                                          
end
