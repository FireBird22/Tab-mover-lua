...
local function CopyRage()
    ...
    Z.SR_AvoidLimbs                         = ui.get(Z.R_AvoidLimbs)                                          Z.SR_AccuracyBoostOptions              = ui.get(Z.R_AccuracyBoostOptions)
    Z.SR_AvoidHead                          = ui.get(Z.R_AvoidHead)                                           Z.SR_QuickStop                         = ui.get(Z.R_QuickStop)
    Z.SR_MultiPoint                         = ui.get(Z.R_MultiPoint)                                          Z.SR_QuickStopEarly                    = ui.get(Z.R_QuickStopEarly)
    Z.SR_MultiPointScale                    = ui.get(Z.R_MultiPointScale)                                     Z.SR_QuickStopInFire                   = ui.get(Z.R_QuickStopInFire)
    Z.SR_DynamicMultiPoint                  = ui.get(Z.R_DynamicMultiPoint)                                   Z.SR_QuickPeekAssist                   = ui.get(Z.R_QuickPeekAssist)
    Z.SR_SafePoint                          = ui.get(Z.R_SafePoint)                                           Z.SR_AntiAimCorrection                 = ui.get(Z.R_AntiAimCorrection)
    Z.SR_StomachScale                       = ui.get(Z.R_StomachScale)                                        Z.SR_PreferBodyAim                     = ui.get(Z.R_PreferBodyAim)
    ...
    Z.SR_ReduceAimStep                      = ui.get(Z.R_ReduceAimStep)
    Z.SR_MaximumFov                         = ui.get(Z.R_MaximumFov)
    Z.SR_LogMissesDueToSpread               = ui.get(Z.R_LogMissesDueToSpread)
    Z.SR_LowFpsMitigations                  = ui.get(Z.R_LowFpsMitigations)
end
...
local function PasteRage()
    ...
    ui.set(Z.R_AvoidLimbs, Z.SR_AvoidLimbs)                                                                   ui.set(Z.R_AccuracyBoostOptions, Z.SR_AccuracyBoostOptions)
    ui.set(Z.R_AvoidHead, Z.SR_AvoidHead)                                                                     ui.set(Z.R_QuickStop, Z.SR_QuickStop)
    ui.set(Z.R_MultiPoint, Z.SR_MultiPoint)                                                                   ui.set(Z.R_QuickStopEarly, Z.SR_QuickStopEarly)
    ui.set(Z.R_MultiPointScale, Z.SR_MultiPointScale)                                                         ui.set(Z.R_QuickStopInFire, Z.SR_QuickStopInFire)
    ui.set(Z.R_DynamicMultiPoint, Z.SR_DynamicMultiPoint)                                                     ui.set(Z.R_QuickPeekAssist, Z.SR_QuickPeekAssist)
    ui.set(Z.R_SafePoint, Z.SR_SafePoint)                                                                     ui.set(Z.R_AntiAimCorrection, Z.SR_AntiAimCorrection)
    ui.set(Z.R_StomachScale, Z.SR_StomachScale)                                                               ui.set(Z.R_PreferBodyAim, Z.SR_PreferBodyAim)
    ...
    ui.set(Z.R_ReduceAimStep, Z.SR_ReduceAimStep)
    ui.set(Z.R_MaximumFov, Z.SR_MaximumFov)
    ui.set(Z.R_LogMissesDueToSpread, Z.SR_LogMissesDueToSpread)
    ui.set(Z.R_LowFpsMitigations, Z.SR_LowFpsMitigations)
end
...
local function CopyAA()
    ...
    Z.SA_EdgeFakeYawOffset                  = ui.get(Z.A_EdgeFakeYawOffset)                                   Z.SA_SlowMotionType                    = ui.get(Z.A_SlowMotionType)
    Z.SA_FreeStanding                       = ui.get(Z.A_FreeStanding)                                        Z.SA_FixLegMovement                    = ui.get(Z.A_FixLegMovement)
    Z.SA_FreeStandingIgnoreDuck             = ui.get(Z.A_FreeStandingIgnoreDuck)                              Z.SA_InfiniteDuck                      = ui.get(Z.A_InfiniteDuck)
    Z.SA_Twist                              = ui.get(Z.A_Twist)                                               Z.SA_OnShotAntiAim                     = ui.get(Z.A_OnShotAntiAim)
    Z.SA_YawJSlider                         = ui.get(YawJSlider)                                              Z.SA_BodyYSlider                       = ui.get(BodyYSlider)
    Z.SA_YawSlider                          = ui.get(YawSlider)
end
...
local function PasteAA()
    ...
    ui.set(Z.A_EdgeFakeYawOffset, Z.SA_EdgeFakeYawOffset)                                                     ui.set(Z.A_SlowMotionType, Z.SA_SlowMotionType)
    ui.set(Z.A_FreeStanding, Z.SA_FreeStanding)                                                               ui.set(Z.A_FixLegMovement, Z.SA_FixLegMovement)
    ui.set(Z.A_FreeStandingIgnoreDuck, Z.SA_FreeStandingIgnoreDuck)                                           ui.set(Z.A_InfiniteDuck, Z.SA_InfiniteDuck)
    ui.set(Z.A_Twist, Z.SA_Twist)                                                                             ui.set(Z.A_OnShotAntiAim, Z.SA_OnShotAntiAim)
    ui.set(YawJSlider, Z.SA_YawJSlider)                                                                       ui.set(BodyYSlider, Z.SA_BodyYSlider)
    ui.set(YawSlider, Z.SA_YawSlider)
end
...
local function CopyVisuals()
    ...
    Z.SV_InstantScope                       = ui.get(Z.V_InstantScope)                                        Z.SV_Pos                               = ui.get(Pos)
    ...
    Z.R45,Z.B45,Z.G45,Z.A45 = ui.get(Color45) Z.R46,Z.B46,Z.G46,Z.A46 = ui.get(Color46) Z.R47,Z.B47,Z.G47,Z.A47 = ui.get(Color47)
end
...
local function PasteVisuals()
    ...
    ui.set(Z.V_InstantScope, Z.SV_InstantScope)                                                               ui.set(Pos, Z.SV_Pos)
    ...
    ui.set(Color45, Z.R45,Z.B45,Z.G45,Z.A45) ui.set(Color46, Z.R46,Z.B46,Z.G46,Z.A46) ui.set(Color47,  Z.R47,Z.B47,Z.G47,Z.A47)
end
...
local function CopyMisc()
    ...
    Z.SM_LogPurchases                       = ui.get(Z.M_LogPurchases)
end
...
local function PasteMisc()
    ...
    ui.set(Z.M_LogPurchases, Z.SM_LogPurchases)                                       
end
