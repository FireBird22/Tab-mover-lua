...
RR.TargetHitbox                           = ui_reference("RAGE", "Aimbot", "Target hitbox")                        RR.QuickPeekAssist                        = ui_reference("RAGE", "Other", "Quick peek assist")
RR.ForceSafePointOnLimbs                  = ui_reference("RAGE", "Aimbot", "Force safe point on limbs")            RR.QuickStop                              = ui_reference("RAGE", "Other", "Quick stop")
RR.MaximumFov                             = ui_reference("RAGE", "Aimbot", "Maximum FOV")                          RR.DelayShot                              = ui_reference("RAGE", "Other", "Delay shot")
...
RR.AutomaticPenetration                   = ui_reference("RAGE", "Aimbot", "Automatic penetration")                RR.DoubleTap                              = ui_reference("RAGE", "Other", "Double tap")
RR.SilentAim                              = ui_reference("RAGE", "Aimbot", "Silent aim")                           RR.DoubleTapMode                          = ui_reference("RAGE", "Other", "Double tap mode")
RR.MinHitchance                           = ui_reference("RAGE", "Aimbot", "Minimum hit chance")                   RR.DoubleTapQuickStop                     = ui_reference("RAGE", "Other", "Double tap quick stop")
RR.MinDamage                              = ui_reference("RAGE", "Aimbot", "Minimum Damage")                       RR.ForceBodyAimOnPeek                     = ui_reference("RAGE", "Other", "Force body aim on peek")
RR.LogMissesDueToSpread                   = ui_reference("RAGE", "Aimbot", "Log misses due to spread")
--------------------------------------------------------------------------------------------------------------ANTI-AIM-REF-------------------------------------------------------------------------------------------------
RA.Pitch                                  = ui_reference("AA", "Anti-aimbot angles", "Pitch")                      RA.Enabled                                = ui_reference("AA", "Fake lag", "Enabled")
RA.YawBase                                = ui_reference("AA", "Anti-aimbot angles", "Yaw base")                   RA.SlowMotionType                         = ui_reference("AA", "Other", "Slow motion type")
...
RA.Yaw, RA.YawSlider                      = ui_reference("AA", "Anti-aimbot angles", "Yaw")
--------------------------------------------------------------------------------------------------------------LEGIT-REF----------------------------------------------------------------------------------------------------
RL.Enabled1                               = ui_reference("LEGIT", "Aimbot", "Enabled")                             RL.MinHitchance                           = ui_reference("LEGIT", "Triggerbot", "Minimum hit chance")
...
RL.AimThroughSmoke                        = ui_reference("LEGIT", "Aimbot", "Aim through smoke")                   RL.ShootWhileBlind                        = ui_reference("LEGIT", "Triggerbot", "Shoot while blind")
RL.AimWhileBlind                          = ui_reference("LEGIT", "Aimbot", "Aim while blind")                     RL.ShootThroughSmoke                      = ui_reference("LEGIT", "Triggerbot", "Shoot through smoke")
...
RL.Stomach1                               = ui_reference("LEGIT", "Aimbot", "Stomach")                             RL.AccuracyBoostRange                     = ui_reference("LEGIT", "Other", "Accuracy boost range")
--------------------------------------------------------------------------------------------------------------VISUALS-REF--------------------------------------------------------------------------------------------------
...
RV.Name, RC.Clr2                          = ui_reference("VISUALS", "Player ESP", "Name")                          RV.ForceThirdPersonDead                   = ui_reference("VISUALS", "Effects", "Force third person (dead)")
...
RV.VisualizeAimbot, RC.Clr51              = ui_reference("VISUALS", "Player ESP", "Visualize aimbot")              RV.InaccuracyOverlay, RC.Clr25            = ui_reference("VISUALS", "Other ESP", "Inaccuracy overlay")
RV.VisualizeSp, RC.Clr52                  = ui_reference("VISUALS", "Player ESP", "Visualize aimbot (safe point)") RV.DroneGun, RC.Clr29                     = ui_reference("VISUALS", "Other ESP", "Drone gun")
...
RV.Player, RC.Clr10                       = ui_reference("VISUALS", "Colored models", "Player")                    RV.Jammer, RC.Clr39                       = ui_reference("VISUALS", "Other ESP", "Jammer")
...
RV.RemoveSmoke                            = ui_reference("VISUALS", "Effects", "Remove smoke grenades")            RV.Radar                                  = ui_reference("VISUALS", "Other ESP", "Radar")
--------------------------------------------------------------------------------------------------------------MISC-REF-----------------------------------------------------------------------------------------------------
...
RM.NoFallDamage, RC.Clr50                 = ui_reference("MISC", "Movement", "No fall damage")                     RM.LogPurchases                           = ui_reference("MISC", "Miscellaneous", "Log weapon purchases")
RM.AirDuck                                = ui_reference("MISC", "Movement", "Air duck")                           RM.RevealOverwatchPlayers                 = ui_reference("MISC", "Miscellaneous", "Reveal Overwatch players")
RM.InfiniteDuck                           = ui_reference("MISC", "Movement", "Infinite duck")                      RM.KnifeBot, RM.KnifeMode                 = ui_reference("MISC", "Miscellaneous", "Knifebot")
RM.FastWalk                               = ui_reference("MISC", "Movement", "Fast walk")                          RM.AutomaticWeapons, RM.ADelay            = ui_reference("MISC", "Miscellaneous", "Automatic weapons")
RM.BlockBot                               = ui_reference("MISC", "Movement", "Blockbot")                           RM.OverrideZoomFov                        = ui_reference("MISC", "Miscellaneous", "Override Zoom FOV")
RM.EasyStrafe                             = ui_reference("MISC", "Movement", "Easy strafe")                        RM.DisableSvPure                          = ui_reference("MISC", "Miscellaneous", "Disable sv_pure")
RM.JumpAtEdge                             = ui_reference("MISC", "Movement", "Jump at edge")                       RM.AntiUntrusted                          = ui_reference("MISC", "Settings", "Anti-untrusted")
RM.ClanTagSpammer                         = ui_reference("MISC", "Miscellaneous", "Clan tag spammer")              RM.LowFpsWarning                          = ui_reference("MISC", "Settings", "Low FPS warning")
RM.LogDamageDealt                         = ui_reference("MISC", "Miscellaneous", "Log damage dealt")              RM.HideFromObs                            = ui_reference("MISC", "Settings", "Hide from OBS")
--------------------------------------------------------------------------------------------------------------SKINS-REF----------------------------------------------------------------------------------------------------
